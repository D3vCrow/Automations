"""
Network Stability Monitor Pro — Portable / Standalone Launcher
---------------------------------------------------------------
Run this file directly:  python Network_Stability_Monitor_Portable.py
Or double-click:         run_stability_monitor.bat
